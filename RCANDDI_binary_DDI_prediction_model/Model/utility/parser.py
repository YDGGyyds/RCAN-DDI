...
def parse_args():
    parser = argparse.ArgumentParser(description="Run RCANDDI.")
    ...
    parser.add_argument('--model_type', nargs='?', default='rcanddi',
                        help='Specify a loss type from {rcanddi}.')
    ...
    parser.add_argument('--n_topo_feats', type=int, default=64, help='dim of topology features')
    parser.add_argument('--n_hid', type=int, default=128, help='num of hidden features')
    parser.add_argument('--n_out_feat', type=int, default=100, help='num of output features')
